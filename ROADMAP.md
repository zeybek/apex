...
- Gather feedback on the planning-workspace hooks (session context, stop guard) and the read-only agents; tune the stop guard's heuristics if it blocks in cases it should not.
